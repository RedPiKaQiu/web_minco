      ...
      <div className="floating-buttons">
        <div className="flex flex-col space-y-3">
          ...
          <button
            ...
            className="w-14 h-14 bg-blue-500 text-white rounded-full shadow-lg hover:bg-blue-600 transition-colors flex items-center justify-center touch-target no-tap-highlight"
          >
            <Plus size={24} />
          </button>
        </div>
